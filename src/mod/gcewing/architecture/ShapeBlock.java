...
//			setBlockBounds(Utils.unionOfBoxes(list));
	...
	@Override
	public void addCollisionBoxToList(IBlockState state, World world, BlockPos pos, AxisAlignedBB clip, List<AxisAlignedBB> result, @Nullable Entity entity, boolean p_185477_7_) {

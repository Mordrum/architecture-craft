    ...
    extends BaseSubsystem implements IGuiHandler
{
    ...
    public <ITEM extends Item> ITEM addItem(ITEM item, String name) {
        ...
        GameRegistry.register(item, new ResourceLocation(Info.modID, name));
...
//      block.setBlockTextureName(qualName);
        ...
        GameRegistry.register(block, new ResourceLocation(Info.modID, name));
        if (creativeTab != null) {
...
//    }
        ...
        int updateFrequency, boolean sendVelocityUpdates)
    {
        ...
        //TODO hard refernce to Info.modID is probably bad
        EntityRegistry.registerModEntity(new ResourceLocation(Info.modID, "entity." + name), cls, name, id, /*base*/this, 256, updateFrequency, sendVelocityUpdates);
    }
